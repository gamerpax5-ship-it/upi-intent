...
- Draft branch `wpay/user-workflow`; current tested commit `692dda0c01821e9e53973971e9e5ab9f2219ea6a`, tree `3f5df3c747ec08bc4aebe86e0fdc0fddbe2a058b`. Production stays at `ed68f8b612912e835987d79113d7a5c1e3ed247c`.
...
- CI run 36187008950 at 692dda0: 65 focused DB/regression checks passed, zero skipped. Full npm suite 539/541 passed; only 2 failures are old migration assertions expecting version 19 (actual 27). New dispute tests exercised concurrent duplicate opening, ownership, responses, finality, holds/releases, negative balances, two original capacity paths, Merchant refund, scoped denial and immutable rows. Existing tests untouched. Local User dashboard and Merchant payout DOM checks passed; protection checker passes 197 frozen hashes.
- Local additions after that tested commit: exact 48h boundary test, resolution notifications, routing provenance excludes invalidated payouts, resolved dispute UI no longer labels released money as held. These require the next isolated CI run.
