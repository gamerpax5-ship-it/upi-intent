...
family("user.payout", "operations", USER, "own_user", [["view", "View own payout jobs and eligible queue", { eligibility: "approved" }], ["claim", "Claim or release an eligible payout"], ["submit", "Submit owned payout evidence", {accessModes:["record"]}]], operational);
family("user.commission", "finance", USER, "own_user", [["view", "View shared commission entitlement"]], { eligibility: "approved" });
family("user.commission_withdrawal", "finance", USER, "own_user", [["view", "View own INR and USDT commission withdrawals", { eligibility: "approved" }], ["create", "Reserve shared commission for withdrawal"], ["cancel", "Cancel an unprocessed commission withdrawal"]], operational);
...
family("user.parking_beneficiaries", "parking", USER, "own_user", [["view", "View Admin/Employee parking beneficiaries"], ["confirm", "Confirm beneficiary added in own banking app", { accessModes:["record"] }]], operational);
family("user.parking_payments", "parking", USER, "own_user", [["view", "View parking payments"], ["create", "Submit parking payment"]], operational);
...
admin('utr_center','transactions',[["view","View normalized scoped UTR evidence"]]);
...
admin("devices", "apk_events", [["view", "View device metadata"], ["pairing.create", "Create pairing descriptor"]]);
...
family("payment_admin", "transactions", ["admin","super_admin"], "admin_tenants", [["approve", "Manually approve a payment", {dependencies:["transactions.view"]}], ["callback", "Retry payment callbacks", {dependencies:["transactions.view","webhooks.view"]}]], {restricted:true});
