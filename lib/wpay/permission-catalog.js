...
family("user.payin_dispute","collections",USER,"own_user",[["view","View own pay-in disputes"],["respond","Respond to own pay-in dispute"]],{eligibility:"approved"});
...
family("merchant.payin_dispute","collections",MERCHANT,"own_merchant",[["view","View own pay-in disputes"],["open","Open dispute on a successful pay-in"]],{eligibility:"approved"});
...
admin("payin_dispute","transactions",[["view","View scoped pay-in disputes"],["resolve","Resolve scoped pay-in disputes"],["proof","Download scoped pay-in dispute proof"]],{accountRequired:true});
