...
async function canStart(client,bank){
 ...
 if(!(await require('../business/collection-policy').access(client,bank.owner_id)).unlimited_collection&&BigInt(balance.available)<=0n)throw new AuthError('FUNDING_REQUIRED');
