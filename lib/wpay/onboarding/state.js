...
async function refresh(client,owner){
 await client.query(`UPDATE wpay_auth.eligibility SET
  ...
  operations_enabled=EXISTS(SELECT 1 FROM wpay_auth.business_bank_accounts b WHERE b.owner_id=$1 AND b.status='running' AND b.approved_version=b.version AND b.verified_version=b.version AND NOT b.frozen AND NOT b.deactivated)
