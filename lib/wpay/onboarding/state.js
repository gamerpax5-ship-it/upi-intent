...
async function canStart(client,bank){
 ...
 if(!(await require('../business/collection-policy').access(client,bank.owner_id)).unlimited_collection&&(!row.capacity_origin_ready||BigInt(balance.available)<=0n))throw new AuthError('FUNDING_REQUIRED');
