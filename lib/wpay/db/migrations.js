...
const migrationPaths = ["001_auth.sql", "002_approval_mfa.sql", "003_runtime_role.sql", "004_resource_links.sql", "005_unscoped_admin.sql", "006_business_core.sql", "007_business_correctness.sql", "008_usdt_funding.sql", "009_funding_runtime_visibility.sql", "010_funding_snapshot_guards.sql", "011_upi_statement_onboarding.sql"].map(file => path.join(__dirname, "../../../migrations/wpay-auth", file));
const LOCK = 57415905;
