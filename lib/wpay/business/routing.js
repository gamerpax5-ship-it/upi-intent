...
function eligibility(candidate,amount,now){
 ...
 add(candidate.operationsEnabled===true,candidate.statementRequired===true?'statement_required':'operations_disabled');add(candidate.funded===true,'funding_required');
