...
function eligibility(candidate,amount,now){
 ...
 add(candidate.bankApproved===true&&candidate.bankVerified===true&&candidate.bankStatus==='running'&&!candidate.bankFrozen&&!candidate.bankDeactivated,'bank_unavailable');
