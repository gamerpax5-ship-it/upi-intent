...
function eligibility(candidate,amount,now){
 ...
 add(candidate.operationsEnabled===true,candidate.statementRequired===true?'statement_required':'operations_disabled');add(adminManaged||candidate.funded===true,'funding_required');
 ...
 add(adminManaged||minor(amount)<=minor(candidate.availableMinor,{zero:true}),'capacity_insufficient');
