...
async function overview(c,userId){
 ...
 return {capacity,commission,payins,payouts,parking,deposits,banks,trend,recent,totalVolumeMinor:(BigInt(payins.volume)+BigInt(payouts.volume)+BigInt(parking.volume)).toString(),timezone:'Asia/Kolkata'};
}
