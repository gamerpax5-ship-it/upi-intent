...
function minor(value,{zero=false}={}){if(typeof value!=='string'||! /^(0|[1-9][0-9]{0,24})$/.test(value))throw new AuthError('INVALID_INPUT');const n=BigInt(value);if(n>MAX||(!zero&&n===0n))throw new AuthError('INVALID_INPUT');return n;}
