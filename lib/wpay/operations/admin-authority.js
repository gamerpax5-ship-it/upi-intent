...
async function run(c,row,context,operation,b){
 ...
 if(operation.endsWith('/create')){
  ...
  result={id,email,permissionVersion:1,status:'active',passwordResetRequired:true,mfaRequired:false,temporaryExpiresAt:credential.temporary_expires_at,loginPath:'/admin'};
