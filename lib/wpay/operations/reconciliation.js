...
class Reconciliation {
 ...
 async observations(client,row,context,body){
  ...
  const records=rows.slice(0,50).map(o=>({orderId:o.id,reference:o.reference,amountMinor:o.amount_minor,currency:'INR',createdAt:o.created_at,paidAt:o.paid_at,status:o.state,evidenceState:o.evidence_state,
