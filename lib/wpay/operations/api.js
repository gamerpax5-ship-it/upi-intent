...
class Operations{
 constructor(options){this.devices=new Devices({...options,source:options.source,pairingSource:options.pairingSource});this.reconciliation=new (require('./reconciliation').Reconciliation)(options);this.utrs=new (require('./legacy-utrs').LegacyUtrs)(options.legacyReader);}
