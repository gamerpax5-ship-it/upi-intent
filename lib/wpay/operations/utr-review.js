...
async function prepare(c,row,context,body,crypto,gateway){
 ...
 if(o.state==='successful')return {status:'successful',reviewStatus:o.utr_digest===o.verified_digest?'verified':'rejected',final:true,message:o.utr_digest===o.verified_digest?'Verified — payment Successful.':'Payment already Successful with a different UTR. This claim was not verified.'};
