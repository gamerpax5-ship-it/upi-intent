...
async function finish(c,row,context,body,crypto,result){
 ...
 const success=o.state==='successful'&&o.evidence_state==='verified'&&o.utr_digest===o.verified_digest,rejected=o.evidence_state==='rejected'||(o.state==='failed'&&o.evidence_state==='verified');
