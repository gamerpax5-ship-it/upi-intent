...
function ready(page){return IMPLEMENTED.has(page.permissionId)||/^(operations\.(devices|otp|employees|transactions|statements)|gateway\.orders|payout\.[a-z-]+|user\.onboarding-[a-z-]+)$/.test(page.destinationId);}
