...
function ready(page){return IMPLEMENTED.has(page.permissionId)||/^(operations\.(devices|otp|employees|transactions|pending-utrs|statements)|gateway\.orders|payout\.[a-z-]+|parking\.(beneficiaries|orders|admin)|user\.onboarding-[a-z-]+)$/.test(page.destinationId);}
