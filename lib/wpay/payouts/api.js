...
const POST=['payout/approval/search','payout/approval/decide','payout/template','payout/merchant-usdt/search','payout/merchant-usdt/get','payout/create','payout/bulk','payout/bulk/validate','payout/get','payout/search','payout/claim','payout/release','payout/submit','payout/review','payout/resolve','payout/proof','payout/withdrawal/create','payout/withdrawal/get','payout/withdrawal/search','payout/withdrawal/transition','payout/hold/manage','payout/hold/search','payout/capability','payout/commission/search','payout/merchant-usdt/create','payout/merchant-usdt/transition'];
...
async function run(core,client,row,context,operation,body,prepared){
 ...
 if(operation==='payout/approval/decide'){
  ...
  permit(context,'payout_operations.resolve');await ledger.lock(client);
