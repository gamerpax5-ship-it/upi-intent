...
async function run(core,client,row,context,operation,body,prepared){
 ...
 if(operation==='payout/template'){if(!merchant)fail('FORBIDDEN');permit(context,'merchant.payout.view',resource(await target(client,row.id)));return require('./uploads').template();}
