...
async function releaseClaim(client,claim,actor,state){
 ...
 await client.query('UPDATE wpay_auth.payout_claims SET state=$2,closed_at=CURRENT_TIMESTAMP WHERE id=$1',[claim.id,state]);
...
module.exports={queue,claim,release,settle,expire,eligible,LEASE_SECONDS};
