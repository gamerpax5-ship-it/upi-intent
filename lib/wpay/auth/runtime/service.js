...
const DEFAULT_GRANTS = Object.freeze({
  user: Object.freeze(["profile.view", "user.overview.view", "support.view", "guide.view", "user.apk.view", "user.source_events.view", ...SELF_SECURITY]),
  merchant: Object.freeze(["profile.view", "profile.update", "merchant.overview.view", "support.view", "merchant.api_docs.view", "merchant.source_events.view", ...SELF_SECURITY]),
  super_admin: Object.freeze(["profile.view", "overview.view", "users.view", "users.approve", "users.reject", "merchants.view", "merchants.approve", "merchants.reject", "apk.view", ...SELF_SECURITY]),
