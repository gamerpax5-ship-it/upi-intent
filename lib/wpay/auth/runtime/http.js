...
const ASSETS = Object.freeze({ [PREFIX]: ["index.html", "text/html"], [PREFIX+"user.html"]: ["user.html","text/html"], [PREFIX+"merchant.html"]: ["merchant.html","text/html"],
  ...
  [PREFIX + "business-locales.js"]: ["business-locales.js", "text/javascript"], [PREFIX+"parking.js"]: ["parking.js","text/javascript"], [PREFIX+"user-role.css"]: ["user-role.css","text/css"], [PREFIX+"merchant-role.css"]: ["merchant-role.css","text/css"] });
