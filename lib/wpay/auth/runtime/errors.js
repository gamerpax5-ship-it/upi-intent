...
const messages = Object.freeze({
  INSUFFICIENT_BALANCE:[409,"Merchant available balance is insufficient."],INSUFFICIENT_COMMISSION:[409,"Available commission entitlement is insufficient."],
  PAYOUT_BANK_REQUIRED:[409,"An approved payout-capable bank is required."],PAYOUT_FEE_CURRENCY:[409,"INR payout requires an INR fixed fee configuration."],PAYOUT_AMOUNT:[409,"Submitted amount must exactly match the payout."],
  MERCHANT_FX_UNCONFIGURED:[409,"USDT settlement rate not configured"],UPLOAD_REJECTED:[400,"The upload was rejected by the file scanner."],
