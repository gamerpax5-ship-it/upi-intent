...
const GET=['gateway/summary','gateway/keys','gateway/webhooks','gateway/orders','gateway/logs','gateway/diagnostics'],POST=['gateway/route-status','gateway/create','gateway/get','gateway/search','gateway/keys/create','gateway/keys/revoke','gateway/webhooks/configure','gateway/webhooks/retry'];
