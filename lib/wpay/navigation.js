...
section("user", "operations", "Operations", [
  ...
  ["parking-beneficiary", "Parking Beneficiary", "user.parking_beneficiaries.create"],
  ["parking-payment", "Parking Payment", "user.parking_payments.create"],
...
section("administration", "transactions", "Transactions", [["transactions", "Orders & Transactions", "transactions.view"], ["reconciliation", "Reconciliation Review", "reconciliation.review"]]);
